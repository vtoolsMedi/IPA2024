...
namespace campaign\module\modules\contactModule\v001\controller;
...
use campaign\module\modules\contactModule\v001\model\form\ContactForm;
...
class ContactController extends AnnotationController {
    public static function getPurl(?HttpSession $session) {
        return $session->getRequest()->getRoute()->getRouteElementByIndex(1);
